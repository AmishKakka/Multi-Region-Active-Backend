...
Suppose I have hosted a **website (static/dynamic) using S3 or EC2** and am providing some kind of large data that i stored in **some kind of DB (S3 or DynamoDB)** at a single location and it replicates to other selected 3 regions. 
